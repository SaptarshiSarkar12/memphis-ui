...
node {
  ...
  try{
	...
	sh(script: """aws route53 change-resource-record-sets --hosted-zone-id Z05132833CK9UXS6W3I0E --change-batch file://record1.json > status1.txt""",    returnStdout: true)   returnStdout: true) 
